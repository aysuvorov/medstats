...
import src.SklearnMainModeller as smm
...
def main(cfg: DictConfig):
    ...
    # Train and validate sklearn models
    TrainValidate = smm.SklearnModeller(
        cfg.data.PATH_TO_PREPROCESSED_DATA,
        cfg.data.PATH_TO_SKLEARN_MODELS,
        cfg.validating.N_OPTUNA_TRIALS,
        cfg.validating.N_CV_SPLITS,
        cfg.RS
        )
    TrainValidate()
