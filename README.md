...
- [Medstats module](#medstats-module)
- [Python scripts](#python-scripts)
  - [Module contents](#module-contents)
      - [Data transformation and cleaning](#data-transformation-and-cleaning)
      - [Hypothesis testing and group comparison](#hypothesis-testing-and-group-comparison)
      - [Regression modeling and risk assessment](#regression-modeling-and-risk-assessment)
      - [Graphical representation of data](#graphical-representation-of-data)
      - [Подготовительные операции с данными](#подготовительные-операции-с-данными)
      - [Тестирование гипотез и сравнение групп](#тестирование-гипотез-и-сравнение-групп)
      - [Модели регрессии и оценка риска](#модели-регрессии-и-оценка-риска)
...
Let me know if you need any further formatting or help!
