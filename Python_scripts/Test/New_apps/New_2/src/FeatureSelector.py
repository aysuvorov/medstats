...
class LassoSelector:
    def __init__(self, save_path, random_state):

        self.save_path = save_path
        self.random_state = random_state
        self.X_train = pd.read_pickle(self.save_path + "/X_train.pkl")
        self.y_train = pd.read_pickle(self.save_path + "/y_train.pkl")
    ...
    def __call__(self):
        ...
        fig.savefig('./data/03_selected_features/Lasso_feature_importance.png', \
        ...
        with open("./data/03_selected_features/Lasso_features.json", "w") as file_path:
...
class XgbSelector(LassoSelector):
    ...
    def __call__(self):
        ...
        plt.barh(features, importance)
        plt.title("Feature importances via coefficients")
        fig.savefig('./data/03_selected_features/Xgb_feature_importance.png', \
            facecolor='white', transparent=False)
        ...
        with open("./data/03_selected_features/Xgb_features.json", "w") as file_path:
            json.dump(selected, file_path)
